...
const firstName: string = "  Mr. Ashfaqur     ";
...
const fullName: string = [firstName.trim(), middleName && middleName.trim(), lastName.trim()].filter(Boolean).join(' ');
...
const extraChars: number = fullName.length - maxLength;
